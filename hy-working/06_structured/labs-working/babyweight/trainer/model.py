# this is a notebook magic function that will write a file output
import shutil
import numpy as np
...
def read_dataset(prefix, mode, batch_size):
    def _input_fn():
        #this entire thing is the '_input_fn()', just the definition, does not run until called later
        def decode_csv(value_column):
            # this function decodes a single value column, passed in to the .map() method of the dataset
...
# Define feature columns, this function returns lists of tf.feature_column objects in the relevant
# deep or wide formats for use in training
def get_wide_deep():
    # Define column types
    # each variable is set to a tf object column, for processing later into the final variables we will use
